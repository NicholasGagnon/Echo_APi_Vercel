      ...
      <nav className="border-b border-zinc-100 dark:border-zinc-800/60 px-6 py-4 flex items-center justify-between sticky top-0 bg-white/90 dark:bg-[#0f0f0f]/90 backdrop-blur-sm z-50 gap-4">
        ...
        <div className="flex items-center gap-5 flex-wrap">
          ...
          <div className="flex items-center gap-5 text-sm flex-wrap">
            <Link href="/" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">{fr ? "Accueil" : "Home"}</Link>
            <Link href="/dashboard" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">{fr ? "Tous les outils" : "All tools"}</Link>
            <Link href="/conversation" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">AI Chat</Link>
            <Link href="/form" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">{fr ? "Créer un projet" : "Create project"}</Link>
            <Link href="/fiche" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">{fr ? "Explorer les projets" : "Explore projects"}</Link>
            <Link href="/talk" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">{fr ? "Avis de la communauté" : "Community feedback"}</Link>
            <Link href="/audit" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">{fr ? "Audition de site web" : "Website audit"}</Link>
            ...
            <Link href="/account" className="text-cyan-600 dark:text-cyan-400 font-semibold">{fr ? "Mon compte" : "My account"}</Link>
          </div>
        </div>
          ...
          {user && (
            <div className="mt-10 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border border-dashed border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950 p-5 rounded-2xl flex flex-col sm:flex-row justify-between items-center gap-4 shadow-sm">
                ...
                <Link href="/fiche" className="px-6 py-2.5 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-semibold text-xs rounded-xl uppercase tracking-wider transition-all shrink-0 text-center hover:bg-zinc-700 dark:hover:bg-zinc-200">
              ...
              <div className="border border-dashed border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950 p-5 rounded-2xl flex flex-col sm:flex-row justify-between items-center gap-4 shadow-sm">
                ...
                <Link href="/talk" className="px-6 py-2.5 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold text-xs rounded-xl uppercase tracking-wider transition-all shrink-0 text-center">
